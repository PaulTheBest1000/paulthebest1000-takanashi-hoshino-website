    ...
    function toggleMusic() {
        if (music.paused) {
            ...
            message.innerHTML = `Music is paused. Take a break! <br> 
                <a href="(https://youtu.be/bGicz6yyFQc?si=sRxlofHR4g6U85qI)" target="_blank" style="color: blue; text-decoration: underline;">
                    [Original Blue Archive OST 234 YouTube Video]
                </a>`;
        }
    }
...
function showMessage() {
    alert('WE LOVE TAKANASHI HOSHINO!!!'); // Show alert with the message
